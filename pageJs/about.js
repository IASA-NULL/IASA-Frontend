...
window.addEventListener('DOMContentLoaded', function () {
    ...
    nowHeaderStat = false
    fobjTop = document.getElementById('firstObj').offsetTop + document.getElementById('firstObj').offsetHeight - 70;
    setInterval(function () {
        if (elem["scrollTop"] < fobjTop && !nowHeaderStat) {
            ...
            document.getElementById('navLoginLabel').style.width = '0';
            ...
            document.getElementById('navLoginLabel').style.width = '84px';
